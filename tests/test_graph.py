"""Tests run against a tiny synthetic mirror, not the 700MB national graph.

The fixture reproduces the three topology facts that actually break queries:
a code reused across jurisdictions, progression edges only on the Multi-State
spine, and hub-and-spoke alignment. If a refactor drops the bridging, these
